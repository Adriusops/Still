...
All significant architectural choices are documented in `DECISIONS.md` with context, options considered, choice made, and rationale. Read it before touching the architecture.
